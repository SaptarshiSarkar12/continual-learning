...
Demonstrates how a neural network trained sequentially on two MNIST splits
(Task A: digits 0–4, Task B: digits 5–9) forgets Task A after learning Task B.
...
# ── Results ──────────────────────────────────────────────────────────────
print(f"\nAccuracy on Task A before Task B training : {accA_before:.3f}")
print(f"Accuracy on Task A after  Task B training : {accA_after:.3f}")
print(f"Accuracy on Task B (final)                : {accB_final:.3f}")
